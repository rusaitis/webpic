...
import { LAYER_KIND_ICON, PARTICLES_PLACEHOLDER_ICON } from "./icons.ts";
...
// 16×16 inline SVGs; fill/stroke come from the rail CSS, like ui/camera/bottomRail. Layer-kind glyphs come
// from ui/layers/icons (shared with the Layers panel); these are the rail-only tool glyphs.
const ICON = {
...
export function installToolRail(
  parent: HTMLElement,
