...
// Pure readout formatters for the top menu bar (ui/topbar/bar): dataset + field labels and the timestep
// index↔value math. Typed-in, string-out — no DOM, no store — so they're node-testable like
// ui/camera/coordsInfo. fieldInfo() throws on an unknown canonical name (pypic's KeyError rule); the field
