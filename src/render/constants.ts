...
// Raymarch step fraction while a camera gesture is live (setCameraMotion "gesture"): ~0.4 keeps
// the volume readable mid-drag at ~2.5× the frame headroom; the settle repaint restores full
// quality. Machine-driven flies use the gentler animating tier (interactionQuality.ts).
