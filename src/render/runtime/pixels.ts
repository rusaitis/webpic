...
// A readback arrives as some ArrayBufferView; both helpers below read it as bytes. Aliases rather
// than copies — each caller decides for itself whether the result needs to be standalone.
function asUint8(data: ArrayBufferView): Uint8Array {
