...
import { installCameraGestures } from "./gestures.ts";
import { createCameraGlide } from "./glide.ts";

// The camera input composer: the glide loop (ui/camera/glide — momentum, held-key nudges, fly-to
// tweens, cameraMotion) plus the pointer gestures that feed it (ui/camera/gestures), the view
